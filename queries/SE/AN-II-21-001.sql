SELECT filter.KODE_KAB, filter.KODE_KEC, filter.NAMA_KEC, 
    ...
    filter.koperasi_kdkmp_value,
    filter.mitra_kdkmp_value,
    filter.KODE_ANOMALI
...
FROM (
    SELECT  
        ...
        nama_usaha,
        badan_usaha_value,
        koperasi_kdkmp_value,
        mitra_kdkmp_value,
        'SE10' AS KODE_ANOMALI
    ...
    WHERE badan_usaha_value = 3 AND koperasi_kdkmp_value = 1 AND mitra_kdkmp_value <>2
) AS filter
